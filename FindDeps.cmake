...
FUNCTION(GLIBC_REQ_VER VER)
    ...
    # HARD-CODED FIX: We know you have 2.39 from ldd
    SET(GLIBC_VERSION "2.39")
    
    MESSAGE(STATUS "GLIBC version manually set to ${GLIBC_VERSION} to bypass WSL detection issues")

    # This part keeps the script happy for downstream logic
    ...
    # Logic for TRF builds
    IF(GLIBC_VERSION VERSION_LESS ${VER} OR GLIBC_VERSION VERSION_EQUAL ${VER})
        MESSAGE(STATUS "Using legacy build settings for TRF...")
